        ...
        <div class="row">
            <div class="col-12">
              ...
              <div class="card-header">
                <h3 class="card-title">Category2 List</h3>
                <a href="category2_add.php"><button class="btn btn-primary float-right">ADD NEW</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <td>
                     <a href="category2_delete.php?id=<?php echo $row['id'];?>"> <i class="fas fa-trash"></i> </a>                     
                      <a href="category2_edit.php?id=<?php echo $row['id'];?>"><i class="fas fa-edit"></i></a>
                  </td>
                  </tr>
                    <?php
                     }
