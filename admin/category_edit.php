              ...
              <form action="category_update_db.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="catname" placeholder="Category name" name="catname" value="<?php echo $row['catname'];?>">
                  ...
                  <div class="form-group">
                    ...
                    <td><img src="../images/categories/<?php echo $row['image'] ?> " alt="" width="100px"></td>
