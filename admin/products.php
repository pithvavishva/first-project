        ...
        <div class="row">
            <div class="col-12">
              ...
              <div class="card-header">
                ...
                <a href="product_add.php"><button class="btn btn-primary float-right">ADD NEW</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    include_once('includes/config.php');
                     ...
                     $subcatresult= mysqli_query($conn,$subcatqry) or exit("Sub Category select fail".mysqli_error($conn));
                     $subcatrow= mysqli_fetch_array($subcatresult);
                    ?>
                     <tr>
                    <td><?php echo $row['id']; ?></td>
                    <td><img src="../images/products/<?php echo $row['image']; ?> " alt="" width="100px"></td>
