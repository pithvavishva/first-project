        ...
        <div class="col-md-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">CATEGORY2 ADD</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="category2_add_db.php" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Category2 name</label>
                    <input type="text" class="form-control" id="catnam" placeholder="Category2 name" name="catnam">
                  </div>
                  <div class="form-group">
