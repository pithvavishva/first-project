...
// ✅ FIXED: Checking the correct parameter
...
// ✅ Query to get subcategories of the given catid
...
<div class="text-center mt-5">
     <h2 class="text-center mb-4">Subcategory</h2>
</div>
<br>
<br>
<!-- Show Subcategories -->
<!-- Add this inside your viewsubcategory.php page where subcategories are displayed -->

<div class="container my-5">
  <div class="row justify-content-center">
    <?php while ($subcatrow = mysqli_fetch_array($subcatresult)) { ?>
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
        <div class="subcategory-card text-center shadow-sm p-3 rounded">
          <a href="viewproduct.php?catid=<?php echo $catid; ?>&subcatid=<?php echo $subcatrow['id']; ?>">
            <div class="subcategory-image-wrapper mb-2">
              <img src="images/subcategories/<?php echo htmlspecialchars($subcatrow['image']); ?>"
                   alt="<?php echo htmlspecialchars($subcatrow['subcatname']); ?>"
                   class="subcategory-image img-fluid">
            </div>
            <h5 class="subcategory-title"><?php echo htmlspecialchars($subcatrow['subcatname']); ?></h5>
          </a>
        </div>
      </div>
    <?php } ?>
